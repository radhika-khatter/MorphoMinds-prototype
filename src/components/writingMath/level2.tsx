  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="p-6 flex flex-col items-center gap-6">
        <h2 className="text-3xl font-bold text-purple-600">Math Writing Level 2</h2>
        <p className="text-gray-700 dark:text-gray-300 max-w-xl text-center">
          Freely practice writing numbers, symbols, or complete math expressions like "12 + 45 = 57".
        </p>
